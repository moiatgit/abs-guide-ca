...
operations <string-manipulation.html#STRINGMANIP>`_ work on arrays.
...
`Command substitution <commandsub.html#COMMANDSUBREF>`_ can construct
...
In an array context, some Bash `builtins <internal.html#BUILTINREF>`_
have a slightly altered meaning. For example,
`unset <internal.html#UNSETREF>`_ deletes array elements, or even an
entire array.
...
analogous to that between `$@ and $\* <internalvariables.html#APPREF>`_.
...
substitution <commandsub.html#COMMANDSUBREF>`_, makes it possible to
...
references <bashver2.html#VARREFNEW>`_ create some fascinating
possibilities
...
do not use arrays, `Example A-15 <contributed-scripts.html#PRIMES>`_,
and `Example 16-46 <mathc.html#PRIMES2>`_.
...
array, see `Example A-10 <contributed-scripts.html#LIFESLOW>`_.

--

For more interesting scripts using arrays, see:

-  `Example 12-3 <commandsub.html#AGRAM2>`_

-  `Example 16-46 <mathc.html#PRIMES2>`_

-  `Example A-22 <contributed-scripts.html#HASHEX2>`_
...
+----------------------------+------------------------+-----------------------+
| `Prev <list-cons.html>`_   | `Home <index.html>`_   | `Next <ivr.html>`_    |
+----------------------------+------------------------+-----------------------+
| List Constructs            | `Up <part5.html>`_     | Indirect References   |
+----------------------------+------------------------+-----------------------+
