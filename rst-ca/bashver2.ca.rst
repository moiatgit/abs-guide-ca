...
+==================================+==========================================+===========================+
| `Prev <bash2.html>`_             | Chapter 37. Bash, versions 2, 3, and 4   | `Next <bashver3.html>`_   |
+----------------------------------+------------------------------------------+---------------------------+
...
+------------------------------+------------------------+---------------------------+
| `Prev <bash2.html>`_         | `Home <index.html>`_   | `Next <bashver3.html>`_   |
+------------------------------+------------------------+---------------------------+
| Bash, versions 2, 3, and 4   | `Up <bash2.html>`_     | Bash, version 3           |
+------------------------------+------------------------+---------------------------+
