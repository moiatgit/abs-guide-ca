...
+======================================+==========================+=============================+
| `Prev <testsandcomparisons.html>`_   | Chapter 36. Miscellany   | `Next <colorizing.html>`_   |
+--------------------------------------+--------------------------+-----------------------------+
...
Can a script `recursively <localvar.html#RECURSIONREF>`_ call itself?
Indeed.
...
+---------------------------------------+---------------------------+-----------------------------+
| `Prev <testsandcomparisons.html>`_    | `Home <index.html>`_      | `Next <colorizing.html>`_   |
+---------------------------------------+---------------------------+-----------------------------+
| Tests and Comparisons: Alternatives   | `Up <miscellany.html>`_   | "Colorizing" Scripts        |
+---------------------------------------+---------------------------+-----------------------------+
