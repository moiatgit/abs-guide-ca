...
+====================================================================+========================================+========================================================+
| `Previ <http://tldp.org/LDP/abs/html/string-manipulation.html>`_   | Capítol 10. Manipulació de variables   | `Següent <http://tldp.org/LDP/abs/html/loops.html>`_   |
+--------------------------------------------------------------------+----------------------------------------+--------------------------------------------------------+
...
+--------------------------------------------------------------------+-----------------------------------------------------------------+--------------------------------------------------------+
| `Previ <http://tldp.org/LDP/abs/html/string-manipulation.html>`_   | `Inici <http://tldp.org/LDP/abs/html/index.html>`_              | `Següent <http://tldp.org/LDP/abs/html/loops.html>`_   |
+--------------------------------------------------------------------+-----------------------------------------------------------------+--------------------------------------------------------+
| Manipulació de strings                                             | `Amunt <http://tldp.org/LDP/abs/html/manipulatingvars.html>`_   | Bucles i branques                                      |
+--------------------------------------------------------------------+-----------------------------------------------------------------+--------------------------------------------------------+
